<?php 
	...
	$con=mysqli_connect("localhost","root","","itpr");
	// Check connection
...
<html>
	<head>
		...
		<div>
			<div style='float:left;width:50%;height:100%;background-color:#ffaaaa;' align='center' id='graph'>
				<div id='test'>title goes here</div>
					...
					<div id = "BarGraph" 	style =	"display : none">
						...
						<div id = "editLables">
							...
							<form action="demo_form.asp">
								...
								Graph Title: 		<input type = "text" style ="width:100"	id = "graphTitle"><br>
			...
			<script type="text/javascript" src="http://54.186.251.162/functions.js"></script><script>createBarGraph(131);</script>
			<script type="text/javascript">
				...
				var gTitle = document.getElementById('graphTitle').value;
				ele.innerHTML = gTitle;
